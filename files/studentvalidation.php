...
<h1><center>TIME-TABLE : SEMESTER</center></h1>
<div id="TT" style="background-color: #FFFFFF">
    <table border="3" cellspacing="3" align="center" id="timetable">
        <caption>
            <strong>		
                <?php
                if (isset($_POST['select_semester'])) {
                    echo "Semester ". $_POST['select_semester'] . " Classroom ";
                    $year = (int)($_POST['select_semester'] / 2) + $_POST['select_semester'] % 2;
                    $r = mysqli_fetch_assoc(mysqli_query(mysqli_connect("localhost", "root", "", "ttms"), "SELECT * from classrooms WHERE status = '$year'"));
                    echo " ( " . $r['name'], " ) ";
                }
                ?>
            </strong>
		...
		<tr>
                ...
                <td style="text-align:center"><b>9:00-10:00</b></td>
                <td style="text-align:center"><b>10:00-11:00</b></td>
                <td style="text-align:center"><b>11:00-12:00</b></td>
                <td style="text-align:center"><b>12:00-01:00</b></td>
                <td style="text-align:center"><b>01:00-02:00</b></td>
                <td style="text-align:center"><b>02:00-03:00</b></td>
                <td style="text-align:center"><b>03:00-4:30</b></td>
            </tr>
        <tr>
            <?php
            $table = null;
            ...
            if (isset($_POST['select_semester']) && $_POST['select_semester'] % 2 !== 0) {
                ...
                echo '</table>';
                $sign = "<b>GENERATED VIA TIME-TABLE : IICMR COLLAGE NIGDI PUNE.</b>";
                if (isset($_POST['select_semester'])) {
